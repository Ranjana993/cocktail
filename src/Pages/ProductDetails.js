...
const ProductDetails = () => {
  ...
  useEffect(() => {
    if (cocktail.length > 0) {
      const { strDrink: name,
        ...
        strGlass: glass, strIngredient1, strIngredient2, strIngredient3,
        strIngredient4, strIngredient5, } = cocktail[0];
  ...
  if (!modified) {
    ...
    const { name, img, info, category, glass, ingredients } = modified;
    return (
      <>
        { loading ? (
          <SpinnerAnim />
